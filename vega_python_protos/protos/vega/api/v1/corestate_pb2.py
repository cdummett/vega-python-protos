...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["DESCRIPTOR"]._serialized_options = (
        b"Z,code.vegaprotocol.io/vega/protos/vega/api/v1\222A:\022\037\n\024Vega core state APIs2\007v0.77.6\032\023lb.testnet.vega.xyz*\002\001\002"
    )
